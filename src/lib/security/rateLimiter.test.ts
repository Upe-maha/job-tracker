// src/lib/security/rateLimiter.test.ts
//
// checkRateLimit needs Mongo and this suite is DB-free, so the enforcement half
// is covered in src/lib/api/guard.test.ts against a stubbed limiter. What's left
...
// This module imports @/lib/db, which throws at import time without
