...
// The real rate limiter imports @/lib/db, which throws at import time unless
...
// Mocking @/lib/auth also keeps NextAuth and the Mongoose models out of the
