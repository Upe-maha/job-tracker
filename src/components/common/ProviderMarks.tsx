...
// Profile link only (Step G's About section) — LinkedIn is not a sign-in
// provider here. currentColor for the same theme reason as the GitHub mark.
...
// fill="currentColor" so it inherits the foreground colour and works in both
// themes, unlike the Google mark's fixed brand fills.
